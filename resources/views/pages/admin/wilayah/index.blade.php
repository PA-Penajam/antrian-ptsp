    ...
    <div class="w-full space-y-6">
        ...
        <flux:card class="admin-stat-success admin-card-elevated p-5">
            ...
            @if ($selectedKabupaten)
                <div class="flex flex-wrap items-center gap-2 rounded-xl bg-emerald-100 px-4 py-3 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300">
                    <span class="font-semibold">{{ $selectedKabupaten->nama }}</span>
                    <flux:badge size="sm" color="emerald">{{ $selectedKabupaten->kode }}</flux:badge>
                </div>
            @else
                    ...
                    <flux:table.rows>
                        @forelse ($kabupatenList as $kabupaten)
                            <flux:table.row>
                                ...
                                <flux:table.cell class="font-medium whitespace-nowrap">{{ $kabupaten->nama }}</flux:table.cell>
                                <flux:table.cell class="whitespace-nowrap">
